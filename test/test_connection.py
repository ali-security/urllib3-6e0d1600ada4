...
class TestConnection(object):
    ...
    @pytest.mark.skip(
        reason="Time bomb: asserts the hardcoded RECENT_DATE (2022-01-01) is less "
        "than two years old, which is false on any rebuild after 2024-01-01. "
        "Not a urllib3 behaviour test."
    )
